<?php
   ...
   } else
   {
      ...
      } else
      {
         ...
         $sql = "INSERT INTO CentrosZonales(id, Nombre, idRegional, Usuario) VALUES ($id, '$Nombre', " . $datos->idRegional. "," . $datos->Usuario . ") ON DUPLICATE KEY UPDATE Nombre = VALUES(Nombre), idRegional = VALUES(idRegional), Usuario = VALUES(Usuario), fechaCargue = '$fecha';";
